...
const sources = [
  ...
  "src/lib/clinician/service.ts", "src/lib/stage/flow.ts", "src/lib/stage/diagnostics.ts", "src/lib/stage/modes.ts", "src/lib/governance/consent.ts", "src/lib/governance/media.ts", "src/lib/governance/emergency.ts", "src/lib/governance/redaction.ts",
